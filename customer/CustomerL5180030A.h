#ifndef __CUSTOMERL5180030A_H  
#define __CUSTOMERL5180030A_H
...
#define	Battery_Materials_InFlash					MnNiCo_Ternary_Battery_PHYLION_NEW
...
#define AH_Battery_InFlash		       	 			28


#define	Wheel_Diameter_Inch_Int_InFlash	    		13
...
#define	BatteryStandardM_InFlash			80000
#define	Rated_Q_Release_PerFrame_A_InFlash		(7)  //等于额定AH*额定速度/额定公里数	两轮车额定速度一般是30km/h	
...
#define	MECHANICALLOCK_EXTERNAL_COMPILE			COMPILE_ENABLE
...
#define DOUSUPPORT_EXTERNAL_COMPILE			COMPILE_DISABLE
...
#define LOCKBUTTON_COMPILE				COMPILE_DISABLE     //一键换车按键
#define	VOICEPACKET_COMPILE				COMPILE_DISABLE
#define VOICEPACKETPWM_COMPILE          COMPILE_ENABLE

#define LONGRENT_COMPILE		                COMPILE_DISABLE


#define		HistoryMileage_COMPILE		        COMPILE_ENABLE
#define		ResetMcuAccWork_COMPILE		        COMPILE_ENABLE

//BLE_E & BLE_G & BLE_J
#define PCB_VERSION				    	ZBJ05A

//China_CountryVersion & Vietnam_CountryVersion
#define COUNTRY_COMPILE					China_CountryVersion

/********************Device Information*****************************/
#define	PCBVersion_DeviceInfo				"ZBJ05A"
#define	FirmwareVersion_DeviceInfo			"2.2.B"	
#define	Customer_DeviceInfo				"L5180030A"	
